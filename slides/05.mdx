...
But there's another bug 🐜! Can you find it?
...
But there's still another bug 🐛!!!! Can you find it?
...
Yup! What if the `dogId` changes before the request finishes? Same problem 😢
...
Phew, glad we squashed all those 😌...

🤔 Hmm... What would this look like with Hooks if we still thought about
lifecycles?
